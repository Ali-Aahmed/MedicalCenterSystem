    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TreatmentJourneySteps", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreatmentJourneySteps_StepNumber",
                table: "TreatmentJourneySteps",
                column: "StepNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Videos_IsPublished",
                table: "Videos",
                column: "IsPublished");
